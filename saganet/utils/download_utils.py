...
links = [
    ...
    {
        "name": "saganet.pth",
        "url": f"{SAGANET_PUB_URL}/ckpts/saganet.pth",
        "md5": "4f3a0ebe86bdf956db289894ec531f5e",
    },
    {
        "name": "saganet_no_lora.pth",
        "url": f"{SAGANET_PUB_URL}/ckpts/saganet_no_lora.pth",
        "md5": "c9fe7b24c6c72574feac27731575d99e",
    },
]
...
def download_model_if_needed(model_path: Path):
    ...
    if (
        ...
        or hashlib.md5(open(model_path, "rb").read()).hexdigest() != target_link["md5"]
    ):
